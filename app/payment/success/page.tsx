      ...
      <Card className="w-[350px]">
        <div className="p-6">
          ...
          <div className="mt-3 text-center sm:mt-5 w-full">
            ...
            <Button asChild className="w-full mt-5 text-white dark:text-white bg-gradient-to-r from-green-400 to-green-600 hover:from-green-500 hover:to-green-700 disabled:opacity-50">
